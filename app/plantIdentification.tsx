...
const handleContinue = (): void => {
  if (selectedPlant) {
    ...
    router.push("/plant-details-review");
  }
};
...
imageContainer: {
  height: 200, // Reduced height to give more space for content
...
resultsScrollContainer: {
  flex: 1,
  marginBottom: 16, // Space between results and buttons
},
resultsTitle: {
  fontSize: 22,
  fontWeight: "700",
...
resultsContent: {
  paddingBottom: 20, // Extra padding at bottom of scroll
},
resultCard: {
...
buttonContainer: {
  ...
  paddingTop: 8,
  paddingBottom: 8,
  backgroundColor: "#ffffff", // Ensure buttons have white background
  borderTopWidth: 1,
