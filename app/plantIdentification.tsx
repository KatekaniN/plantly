...
// Use Expo Router hooks instead of props
...
}, [imageUri, setCurrentImage, identifyPlant, router]);
...
// Safety check for imageUri
if (!imageUri) {
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.errorContainer}>
        <Text style={styles.errorTitle}>No Image Provided</Text>
        <Text style={styles.errorText}>
          Please go back and take a photo first.
        </Text>
